...
VALID_SEASON_DATES = {
    2015: (date(2015, 3, 1), date(2015, 11, 1)),
    2016: (date(2016, 2, 28), date(2016, 11, 2)),
    2017: (date(2017, 2, 22), date(2017, 11, 1)),
    2018: (date(2018, 2, 21), date(2018, 10, 28)),
    2019: (date(2019, 2, 22), date(2019, 10, 30)),
    2020: (date(2020, 7, 22), date(2020, 10, 27)),
    2021: (date(2021, 2, 28), date(2021, 11, 2)),
    2022: (date(2022, 3, 17), date(2022, 11, 5)),
    2023: (date(2023, 2, 24), date(2023, 11, 1)),
    2024: (date(2024, 2, 22), date(2024, 10, 30)),
    2025: (date(2025, 2, 20), date(2025, 2, 28)) # Will fix this as the season progresses, doesn't have spring training for covid.
    }
...
class Crawler(ABC):
    ...
    def rate_limiter(self, rate = 10) -> None: # Random wait calls
        ...
        time_elapsed = current_time - last_called
